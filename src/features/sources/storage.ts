...
const CURRENT_SOURCES_VERSION = 5 // 强制同步 - 整合46个片源
...
const DEFAULT_SOURCES: LocalVodSource[] = [
  ...
  { key: 'feifan', name: '非凡线路', apiUrl: 'http://ffzy5.tv/api.php/provide/vod', detailUrl: 'http://ffzy5.tv/api.php/provide/vod', enabled: true },
